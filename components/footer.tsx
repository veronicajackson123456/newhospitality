          ...
          <div className="lg:col-span-2">
            <Link href="/" className="flex items-center gap-3 mb-5">
              ...
              <div>
                ...
                <div className="text-xs text-gray-400">Hospitality Software Solutions</div>
              </div>
            </Link>
        ...
        <div className="mt-12 pt-8 border-t border-gray-700">
          <div className="flex flex-col gap-4">
            <p className="text-xs text-gray-500 leading-relaxed">
              <strong className="text-gray-400">HMCTS LLC</strong> — Incorporated in the State of Delaware, United States. Entity Number: 204421330. EIN: 37-2155102. Registered Agent Address: 131 Continental Drive, Newark, Delaware 19713, USA. UK Office (operational, not a registered office): 84 Swinton Hall Road, Swinton, Manchester, M27 4BJ, UK. HMCTS LLC is not registered in the United Kingdom.
            </p>
